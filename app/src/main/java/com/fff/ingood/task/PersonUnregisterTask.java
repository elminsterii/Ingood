...
public class PersonUnregisterTask extends HttpRequestTask<Person, Integer, Void> {

    public PersonUnregisterTask(AsyncHttpRequestResponder<Integer, Void> responder) {
        super(responder);
    }

...
public class DoActivityQureyByAttrTask extends HttpPostAbstractTask<ActivityAttr, String>{
    ...
    @Override
    protected String access(Activity activity, ActivityAttr attr) {
        {
            ...
            jsonString = new Gson().toJson(attr, ActivityAttr.class);

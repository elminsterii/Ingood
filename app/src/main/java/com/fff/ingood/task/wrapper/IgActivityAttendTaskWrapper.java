...
public class IgActivityAttendTaskWrapper {

    public enum ATTEND_VALUE {AV_CANCEL_ATTEND, AV_ATTEND}

    public interface IgActivityAttendTaskWrapperCallback {
        void onAttendSuccess();
        void onAttendFailure(Integer iStatusCode);
    }

    private IgActivityAttendTask task;
    private IgActivityAttendTaskWrapperCallback mCb;

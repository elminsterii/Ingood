...
public class DoPersonAccessIconTask<Object> extends HttpPostAbstractTask<Object>{
    public DoPersonAccessIconTask(Activity activity, AsyncResponder<String> responder) {
    ...
    protected String access(Activity activity, Object info) {
        {
            ...
            try
            {
                ...
                url = new URL(String.valueOf(HttpProxy.HTTP_POST_API_PERSON_ACCESS_ICON)+"/email"+"/password");

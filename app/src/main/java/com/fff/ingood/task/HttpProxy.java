...
public class HttpProxy {
    ...
    public static final String HTTP_GET_API_PERSON_ACCESS_ICON = SERVER_URL + "/accesspersonicon";
    public static final String HTTP_DELETE_API_PERSON_ICON = SERVER_URL +"/deletepersonicon";

...
public class IgActivityAttendTask extends HttpRequestTask<JsonObject, Integer, Void> {

    public IgActivityAttendTask(AsyncHttpRequestResponder<Integer, Void> responder) {
        super(responder);
    }
